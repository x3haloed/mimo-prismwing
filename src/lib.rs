...
pub use text_endpoint::{
    ...
    K4SourceTailLayerParity, K4SourceTailOverlayReport, Layer0TraceReport, Layer1ExpertTraceReport,
    Layer1RoutingTraceReport, Layer4MetalDiagnosticReport, LayerMajorMoeReport,
    MetalIncrementalTextReport, MetalNativeRoutedLayerBenchmarkReport,
    NativeMtpPrefillCaptureReport, PrefillRouteCoverageLedger, PrefillRouteCoverageTraceReport,
    ...
    run_k4_source_layer28_tail_overlay, run_layer_major_moe_slice, run_layer4_metal_diagnostic,
    ...
    run_prefill_route_coverage_trace, run_pressure_resident_checkpoint_pilot,

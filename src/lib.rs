...
pub use text_endpoint::{
    ...
    run_arbitrary_text_generation, run_arbitrary_text_q4_diagnostic,
    run_arbitrary_text_resident_route_trace, run_arbitrary_text_resident_set_route_trace,
    run_arbitrary_text_route_trace, run_full_prefix_trace, run_global_attention_capture_smoke,
    ...
    run_native_mtp_prefill_capture, run_native_mtp_window_capture,

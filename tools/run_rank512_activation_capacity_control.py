#!/usr/bin/env python3
"""Run PW-0125 through the shared activation-weighted pilot executor."""
...
try:
    from tools.run_rank768_activation_weighted_expert_pilot import PW0125_SPEC, run
except ModuleNotFoundError:
    from run_rank768_activation_weighted_expert_pilot import PW0125_SPEC, run

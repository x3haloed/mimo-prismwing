...
- Status: in progress; code slice complete
...
next falsifier is multilingual candidate-control-candidate because its PW-0211
pilot accepted only one token; rare-route follows if the complete-path result
remains positive. Longer-context and untouched holdouts remain required after
category broadening.
